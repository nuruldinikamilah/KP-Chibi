...
<body oncontextmenu="return false" onselectstart="return false" ondragstart="return false">-->
							...
							<ul class='nav'>
								...
								<li class='has-sub'>
									<a href='javascript:;'>
										...
										<ul class='sub-menu' <?php if(($_GET['act']=='daftar_reviewer')||($_GET['act']=='rubik_penilaian'))  echo "style='display:block;'"; else echo""?> >
												<li><a href="view.php?menu=reviewer&act=daftar_reviewer"><span class='<?php if($_GET['act']=='daftar_reviewer') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='daftar_reviewer') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Reviewer</span></a></font></li>
										</li>
										<li class='has-sub'>
											<li><a href="view.php?menu=direktur_lppm&act=rubik_penilaian"><span class='<?php if($_GET['act']=='rubik_penilaian') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='rubik_penilaian') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Rubik Penilaian</span></a></font></li>
										</li>
							</ul>
								...
								<li class='has-sub'>
									...
									<ul class='sub-menu' <?php if(($_GET['act']=='daftar_pengajuan')||($_GET['act']=='daftar_pengajuan_validasi')||($_GET['act']=='laporan_pengajuan_penelitian')) echo "style='display:block;'"; else echo""?> >
										<li class='has-sub'>
											<li>
												<a href="view.php?menu=pengajuan&act=daftar_pengajuan"><span class='<?php if($_GET['act']=='daftar_pengajuan') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='daftar_pengajuan') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Pemetaan Reviewer</span></a></font>
											</li>
										</li>
										<li class='has-sub'>
											<li class='has-sub'>
												<li>
													<a href="view.php?menu=direktur_lppm&act=daftar_pengajuan_validasi"><span class='<?php if($_GET['act']=='daftar_pengajuan_validasi') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='daftar_pengajuan_validasi') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Validasi Penerimaan Proposal</span></a></font>
												</li>
											</li>
										</li>
										<li class='has-sub'>
											<li>
												<a href="view.php?menu=pengajuan&act=laporan_pengajuan_penelitian"><span class='<?php if($_GET['act']=='laporan_pengajuan_penelitian') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='laporan_pengajuan_penelitian') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Laporan Pengajuan Penelitian</span></a></font>
											</li>
										</li>
									</ul>
									...
									<ul class='sub-menu' <?php if(($_GET['act']=='daftar_pengajuan_pengabdian')||($_GET['act']=='daftar_pengajuan_validasi_pengabdian')||($_GET['act']=='laporan_pengajuan_pengabdian')) echo "style='display:block;'"; else echo""?> >
										<li class='has-sub'>
											<li>
												<a href="view.php?menu=pengajuan&act=daftar_pengajuan_pengabdian"><span class='<?php if($_GET['act']=='daftar_pengajuan_pengabdian') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='daftar_pengajuan_pengabdian') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Pemetaan Reviewer</span></a></font>
											</li>
										</li>
										<li class='has-sub'>
											<li class='has-sub'>
												<li>
													<a href="view.php?menu=direktur_lppm&act=daftar_pengajuan_validasi_pengabdian"><span class='<?php if($_GET['act']=='daftar_pengajuan_validasi_pengabdian') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='daftar_pengajuan_validasi_pengabdian') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Validasi Penerimaan Proposal</span></a></font>
												</li>
											</li>
										</li>
										<li class='has-sub'>
											<li>
												<a href="view.php?menu=pengajuan&act=laporan_pengajuan_pengabdian"><span class='<?php if($_GET['act']=='laporan_pengajuan_pengabdian') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='laporan_pengajuan_pengabdian') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Laporan Pengajuan Penelitian</span></a></font>
											</li>
										</li>
									</ul>
					...
					function call_menu_dosen()
					{
						...
						<ul class='nav'>
							...
							<li class='has-sub'>
								...
								<ul class='sub-menu' <?php if($_GET['menu']=='penelitian') echo "style='display:block;'"; else echo""?> >
									<li class='has-sub'>
										...
										{
											?>
											<li><a href="view.php?menu=penelitian&act=usulan_didaftarkan&act2=exp"><span class='<?php if($_GET['act']=='usulan_baru_langkah_satu') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='usulan_baru_langkah_satu') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Usulan Baru</span></a></font></li>
										<?php
										}
										else
										{
											?>
											<li><a href="view.php?menu=penelitian&act=usulan_baru_langkah_satu"><span class='<?php if($_GET['act']=='usulan_baru_langkah_satu') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='usulan_baru_langkah_satu') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Usulan Baru</span></a></font></li>
											<?php
										}
										?>
									...
									<li><a href="view.php?menu=penelitian&act=status_pengajuan"><span class='<?php if($_GET['act']=='status_pengajuan') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='status_pengajuan') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'> Status Pengajuan</span></a></font>
									</li>
								...
								<ul class='sub-menu' <?php if($_GET['menu']=='pengabdian') echo "style='display:block;'"; else echo""?> >
									<li class='has-sub'>
									...
									<?php
										...
										{
											?>
											<li><a href="view.php?menu=pengabdian&act=usulan_didaftarkan&act2=exp"><span class='<?php if($_GET['act']=='usulan_baru_langkah_satu') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='usulan_baru_langkah_satu') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Usulan Baru</span></a></font></li>
											<?php
										}
										else
										{
											?>
											<li><a href="view.php?menu=pengabdian&act=usulan_baru_langkah_satu"><span class='<?php if($_GET['act']=='usulan_baru_langkah_satu') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='usulan_baru_langkah_satu') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Usulan Baru</span></a></font></li>
											<?php
										}
									?>

									
									<li><a href="view.php?menu=pengabdian&act=usulan_didaftarkan"><span class='<?php if($_GET['act']=='usulan_didaftarkan') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='usulan_didaftarkan') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'> Usulan Di Daftarkan</span></a></font>
									</li>
									<li><a href="view.php?menu=pengabdian&act=daftar_laporan_kemajuan"><span class='<?php if($_GET['act']=='daftar_laporan_kemajuan') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='daftar_laporan_kemajuan') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Laporan Kemajuan</span></a></font>
									</li>
								</ul>
					...
					function call_menu_reviewer()
					{
						...
						<ul class='nav'>
								<li class='has-sub'>
									...
									<ul class='sub-menu' <?php if($_GET['menu']=='pengajuan') echo "style='display:block;'"; else echo""?> >
										<li class='has-sub'>
											<li>
												 <a href="view.php?menu=pengajuan&act=daftar_pengajuan_rev"><span class='<?php if($_GET['act']=='daftar_pengajuan_rev') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='daftar_pengajuan_rev') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Daftar Pengajuan  Penelitian</span></a></font>
												
												<a href="view.php?menu=pengajuan&act=daftar_pengajuan_rev_pengabdian"><span class='<?php if(($_GET['menu']=='pengajuan')&&($_GET['act']=='daftar_pengajuan_rev_pengabdian')) echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if(($_GET['menu']=='pengajuan')&&($_GET['act']=='daftar_pengajuan_rev_pengabdian')) echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Daftar Pengajuan Pengabdian</span></a></font>
											</li>
										</li>
									</ul>
								</li>
								<li class='has-sub'>
									...
									<ul class='sub-menu' <?php if($_GET['menu']=='laporan_kemajuan') echo "style='display:block;'"; else echo""?> >
										<li class='has-sub'>
											<li>
												 <a href="view.php?menu=laporan_kemajuan&act=daftar_kemajuan_pengabdian_rev"><span class='<?php if($_GET['act']=='daftar_kemajuan_pengabdian_rev') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='daftar_kemajuan_pengabdian_rev') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Daftar Laporan Kemajuan</span></a></font>
											</li>
										</li>
									</ul>
								</li>
						...
						?>
							<ul class='nav'>
								...
								<li class='has-sub'>
									...
									<ul class='sub-menu' <?php if($_GET['act']=='daftar_reviewer') echo "style='display:block;'"; else echo""?> >
										<li class='has-sub'>
											<li><a href="view.php?menu=reviewer&act=daftar_reviewer"><span class='<?php if($_GET['act']=='daftar_reviewer') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='daftar_reviewer') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Reviewer</span></a></font></li>
										</li>
									</ul>
								...
								<li class='has-sub'>
									...
									<ul class='sub-menu' <?php if($_GET['menu']=='pengajuan') echo "style='display:block;'"; else echo""?> >
										<li class='has-sub'>
											<li>
												<a href="view.php?menu=pengajuan&act=daftar_pengajuan"><span class='<?php if(($_GET['menu']=='pengajuan')&&($_GET['act']=='daftar_pengajuan')) echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if(($_GET['menu']=='pengajuan')&&($_GET['act']=='daftar_pengajuan')) echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Pemetaan Reviewer Penelitian</span></a></font>
												
												<a href="view.php?menu=pengajuan&act=laporan_pengajuan_penelitian"><span class='<?php if(($_GET['menu']=='pengajuan')&&($_GET['act']=='laporan_pengajuan_penelitian')) echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if(($_GET['menu']=='pengajuan')&&($_GET['act']=='laporan_pengajuan_penelitian')) echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Laporan Pengajuan Penelitian</span></a></font>

												<a href="view.php?menu=pengajuan&act=daftar_pengajuan_pengabdian"><span class='<?php if(($_GET['menu']=='pengajuan')&&($_GET['act']=='daftar_pengajuan_pengabdian')) echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if(($_GET['menu']=='pengajuan')&&($_GET['act']=='daftar_pengajuan_pengabdian')) echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Pemetaan Reviewer Pengabdian</span></a></font>

												<a href="view.php?menu=pengajuan&act=laporan_pengajuan_pengabdian"><span class='<?php if(($_GET['menu']=='pengajuan')&&($_GET['act']=='laporan_pengajuan_pengabdian')) echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if(($_GET['menu']=='pengajuan')&&($_GET['act']=='laporan_pengajuan_pengabdian')) echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'>Laporan Pengajuan Pengabdian</span></a></font>
	...
	<script>
		...
		{
			$.blockUI({ message: "<br><img src='img/logo_unikom_kecil.jpg'>&nbsp;&nbsp;<b>Mengambil Data...&nbsp;&nbsp;<img src='img/logo_unikom_kecil.jpg'></b><center><br><img src='img/loadinganimation.gif'><br>." }); 
			 //unblock
			 $.unblockUI();
...
$(document).ready(function()
{
    ...
    {  
    		...
    		$.blockUI({ message: "<br><img src='img/logo_unikom_kecil.jpg'>&nbsp;&nbsp;<b>Mencari Data Dosen "+kata_kunci+" ...&nbsp;&nbsp;<img src='img/logo_unikom_kecil.jpg'></b><center><br><img src='img/loadinganimation.gif'><br>." });  
    		$.ajax({
	            ...
	            $('#banyak_data_peneliti').val(banyak_data_peneliti);*/
	             // get txn id from current table row
				    ...
				    var callback = function() 
				    {
				      ...
				      $('#tr'+nip).fadeOut(1000, function(){ $(this).remove();});
...
$(document).ready(function()
{
    ...
    {  
    		...
    		$.blockUI({ message: "<br><img src='img/logo_unikom_kecil.jpg'>&nbsp;&nbsp;<b>Mencari Data Mahasiswa "+kata_kunci_mhs+" ...&nbsp;&nbsp;<img src='img/logo_unikom_kecil.jpg'></b><center><br><img src='img/loadinganimation.gif'><br>." });
    		$.ajax({
...
function cari_ubah_peneliti()
{
    		...
    		$.blockUI({ message: "<br><img src='img/logo_unikom_kecil.jpg'>&nbsp;&nbsp;<b>Mencari Data Peneliti "+kata_kunci_ubah+" ...&nbsp;&nbsp;<img src='img/logo_unikom_kecil.jpg'></b><center><br><img src='img/loadinganimation.gif'><br>." });
    		$.ajax({
...
$('#ubah-nip-session-anggota-peneliti').on('show.bs.modal', function(e) 
{
            ...
            //animasi 
            $('#tr'+data_split[1]).animate({backgroundColor: "#33AAFF" },1000);
	   		$('#tr'+data_split[1]).animate({backgroundColor: "#F9F9F9" },10000);
	   		//end animasi
      ...
      success: function(msg)
      {
        ...
        if (data[0]=="sukses")
        {
           ...
           if (keterangan_anggota_ubah=='DosenLuar')
           {
        	...
        	//animasi 
	            $('#tr'+idx).animate({backgroundColor: "#33AAFF" },1000);
		   		$('#tr'+idx).animate({backgroundColor: "#F9F9F9" },10000);
		   		//end animasi
...
$(document).ready(function()
{
    ...
    {  
    		...
    		$.blockUI({ message: "<br><img src='img/logo_unikom_kecil.jpg'>&nbsp;&nbsp;<b>Menunggu Data "+kata_kunci_dosen_luar+" ...&nbsp;&nbsp;<img src='img/logo_unikom_kecil.jpg'></b><center><br><img src='img/loadinganimation.gif'><br>." });
    		$.ajax({
 ...
 function validasi_pengajuan_koreksi()
  {
	...
	if($('#komentar').val() =="" )
	{
		...
		$('#komentar').css({backgroundColor: "#DCDCDC" },1000);
		$('#komentar').focus();
		return false;
	}
...
$('#file_dokumen_mitra_abdi').change(function(e)
{
	...
	{	
		if ($('#file_dokumen').val()=="")
		{
			...
			//$('#tdstatuspeneliti').addClass("danger");
			$('#file_dokumen').focus();
			$('#t_dokumen_file').animate({backgroundColor: "#33AAFF" },1000);
	   		$('#t_dokumen_file').animate({backgroundColor: "#FFFFFF" },10000);
			return false;	
		}
		else if ($('#file_dokumen_lembar_pengesahan').val()=="")
		{
			...
			$('#t_dokumen_file_lp').animate({backgroundColor: "#FF0000" },1000);
	   		$('#t_dokumen_file_lp').animate({backgroundColor: "#FFFFFF" },10000);
			return false;	
		}
