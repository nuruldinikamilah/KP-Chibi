						...
						<ul class='nav'>
							...
							<li class='has-sub'>
								...
								<ul class='sub-menu' <?php if($_GET['menu']=='penelitian') echo "style='display:block;'"; else echo""?> >
									...
									<li><a href="view.php?menu=penelitian&act=list_pengajuan"><span class='<?php if($_GET['act']=='list_pengajuan') echo"blink"/*BLINK*/; else echo""/*Tidak Blink*/?>'><font color='<?php if($_GET['act']=='list_pengajuan') echo"red"/*BLINK*/; else echo""/*Tidak Blink*/?>'> Status Pengajuan</span></a></font>
									</li>
								</ul>
