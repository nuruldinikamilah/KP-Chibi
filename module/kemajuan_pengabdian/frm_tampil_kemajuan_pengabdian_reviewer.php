      ...
      <!-- begin panel -->
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Daftar Laporan Kemajuan Pengabdian Tahun <?php echo date("Y"); ?>&nbsp; Reviewer <?php echo $_SESSION['nama_user']; ?></h4>
            </div>
            <div class="panel-body">
                ...
                <table id="example" class="table table-striped table-bordered">
                    <thead>
                       <tr><th width="5%">No.</th><th width="10%">Tahun Pengajuan</th><th width="20%">Judul</th><th>Rumpun Pengabdian</th><th>Dana Pengajuan</th><th>Pengusul Pengabdian Internal</th><th>Status Pengajuan</th><th>Skema Pengabdian</th><th>File Dokumen Kemajuan</th><th>Nilai Kemajuan Pengabdian</th><th>&nbsp;</th></tr>
                    </thead>
                    <tbody>
                       <?php
                     ...
                     while($r=mysqli_fetch_array($sql_data_master))
                     {
                        ...
                        <tr id=tr<?php echo $idx_enc;?>>
                           ...
                           <td>
                            ...
                            <td><span class="text-bold"><?php echo ucfirst($r['nama_pengisi']);?></span>
                            <?php
                            ...
                            <?php
                                ...
                                {
                                  ?>
                                  <td><b><a href="<?php echo "dokumen_upload_kemajuan_pengabdian/".$r['dokumen_laporan_kemajuan'];?>" download>File Dokumen</a></span>
                                  <?php
                                    $form_proposal=1;
                                }
                                else
                            ...
                            <?php
                              ...
                              {
                                ?>
                                <td><span class="text-bold"><?php echo $r['nilai_laporan_kemajuan'];?></span>
                                <?php
                              }
                              else
                              {
                            ...
                            ?>
                             <td>
                                <button type="button" class="btn btn-success btn-icon btn-circle" data-toggle="modal" data-target="#kemajuan_koreksi_pengabdian"  id=<?php echo "kemajuan_koreksi_pengabdian|".$idx_enc?>><i class="fa fa-external-link"></i></button> 
                        </tr>
