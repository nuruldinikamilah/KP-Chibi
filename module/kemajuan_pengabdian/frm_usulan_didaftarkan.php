    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse">
          ...
          <table class="table table-striped">
              <thead>
                <tr><th width="5%">No.</th><th width="8%">Tahun Pengajuan</th><th width="15%">Judul</th><th>Personil Pengabdian</th><th width="10%">Rumpun Pengabdian</th><th>Dana</th><th>Status Proposal</th><th>File Dokumen Kemajuan</th><th>&nbsp;</th></tr>
                 </thead>
                    <tbody>
                        <?php
                        ...
                        <tr id=tr<?php echo $idx_enc;?>>
                           ...
                           <td>
                            ...
                            <?php
                                ...
                                {
                                  ?>
                                  <td><b><a href="<?php echo "dokumen_upload_kemajuan_pengabdian/".$r['dokumen_laporan_kemajuan'];?>" download>File Berhasil Diupload</a></span>
                                  <?php
                                    $form_proposal=1;
                                }
                                else
                             ...
                             <td>
                              ...
                              <a href="<?php echo "view.php?menu=pengabdian&act=usulan_baru_langkah_satu&idx=".$idx_enc;?>" class="btn btn-primary btn-sm m-r-5"><i class="fa fa-edit"></i>&nbsp;Lihat Data
                              </a>
                              <a href="<?php echo "view.php?menu=pengabdian&act=unggah_dokumen_kemajuan&idx=".$idx_enc;?>" class="btn btn-danger btn-sm m-r-5"><i class="fa fa-file-powerpoint-o"></i>&nbsp;Laporkan Kemajuan
                              </a>
                              </tr>
                        </tr>
