...
if ($_POST['act']=='pengajuan_koreksi')
{
 ...
 <form action="module/pengajuan/get_data_koreksi_reviewer_submit.php" method="post"  name="frm" class="form-inline" onsubmit="return validasi_pengajuan_koreksi();">


  <!-- tampil history penelitian -->
  <table class="table table-condensed table-striped table-bordered">
                <tbody>
                    <tr>
                        <td class="width:100%" colspan="5">
                          <b><span class="blink"><font color="red"><b>Rekam Jejak Ketua Peneliti 5 Tahun Terakhir</b></span></font></b>
                       </td>
                    </td>
                 </tr>
                 <td></td>
  ...
  <!-- end tampil history penelitian -->




  <input type="hidden" value="<?php echo $_POST['data_id'];?>" name="idx_penelitian">
  <input type="hidden" value="<?php echo my_simple_crypt($rs['judul'], 'e' );?>" name="judul"> 
                ...
                <tbody>
                    <tr>
                        <td class="width:100%" colspan="5">
                          <?php $skema = $rs['skema']?>
                          <center><b>Form Penilaian Pengajuan Proposal <?php echo ucwords($rs['skema']);?></b></center>
                       </td>
                    </td>
                   <td class="width:60%">
                      <center><b>File Pengajuan Proposal</b></center>
                    </td>
                 </tr>
            <tr>
                ...
                <th rowspan="10">
                  <?php
                        ...
                        {
                          ?>
                          <embed src="<?php echo "dokumen_upload/".$rs['dokumen_proposal'];?>" type="application/pdf" frameborder="0" width="100%" height="700px">
            ...
            <?php
              //tampil kuesioner
              $data_skema=str_replace(' ', '_', $rs['skema']);
              ...
              $sql_get_data_kuesioner=mysqli_query($server1,"SELECT 
                                                            ...
                                                            INNER JOIN
                                                             `penilaian_rubik`
                                                            ON `ref_rubik`.`idx_rubik` = `penilaian_rubik`.`idx_rubik`
                                                            WHERE `ref_rubik`.`nama_skema`='".$data_skema."' AND `idx_penelitian`='".$data_id."' 
            ...
            <input type="hidden" value="<?php echo $jumlah_data;?>" name="jumlah_data">
               <tr>
                   ...
                   <input type="hidden" name="idx_nilai_1" value="<?php echo $idx_penilaian[0];?>">
                    ...
                    <td class="text-left">
                    <?php
                      $title[5]="Ketua peneliti pernah menjadi penulis pertama dalam artikel jurnal internasional atau nasional terakreditasi (Sinta 1-3) dalam bidang terkait ";
                      $title[4]="Ketua peneliti pernah menjadi penulis pertama dalam artikel jurnal nasional terakreditasi (Sinta 4-6) dalam bidang terkait ";
                      $title[3]="Ketua peneliti pernah menjadi penulis pertama dalam jurnal tidak terakreditasi atau prosiding seminar nasional maupun internasional";
                      $title[2]="Lainnya";
                    ?>
                ...
                <tr>
                    ...
                    <td class="text-left">
                    <?php
                      $title[5]="Rumusan masalah diuraikan dengan jelas dan terperinci";
                      $title[3]="Rumusan masalah diuraikan kurang jelas dan atau kurang terperinci";
                    ?>
                    5<input type="radio" name="answer_1" value="<?php echo 5*$data_bobot[1]."|5";?>" <?php if($skala[1]=='5'){ echo "checked=checked";}  ?>   title="<?php echo $title[5];?>">
                    4<input type="radio" name="answer_1" value="<?php echo 4*$data_bobot[1]."|4";?>" <?php if($skala[1]=='4'){ echo "checked=checked";}  ?>   title="<?php echo $title[5];?>">
                    3<input type="radio" name="answer_1" value="<?php echo 3*$data_bobot[1]."|3";?>" <?php if($skala[1]=='3'){ echo "checked=checked";}  ?>   title="<?php echo $title[3];?>">
                    2<input type="radio" name="answer_1" value="<?php echo 2*$data_bobot[1]."|2";?>" <?php if($skala[1]=='2'){ echo "checked=checked";}  ?>   title="<?php echo $title[3];?>">
                    1<input type="radio" name="answer_1" value="<?php echo 1*$data_bobot[1]."|1";?>" <?php if($skala[1]=='1'){ echo "checked=checked";}  ?>   title="<?php echo $title[3];?>">
                  </td>
                  ...
                  <tr>
                    ...
                    <td class="text-left">
                    <?php
                      $title[5]="Tujuan penelitian sesuai dengan rumusan masalah dan diuraikan terperinci ";
                      $title[3]="Tujuan penelitian kurang sesuai rumusan masalah dan atau kurang diuraikan terperinci ";
                    ?>
                    5<input type="radio" name="answer_2" value="<?php echo 5*$data_bobot[2]."|5";?>" <?php if($skala[2]=='5'){ echo "checked=checked";}  ?>  title="<?php echo $title[5];?>">
                    4<input type="radio" name="answer_2" value="<?php echo 4*$data_bobot[2]."|4";?>" <?php if($skala[2]=='4'){ echo "checked=checked";}  ?>  title="<?php echo $title[5];?>">
                    3<input type="radio" name="answer_2" value="<?php echo 3*$data_bobot[2]."|3";?>" <?php if($skala[2]=='3'){ echo "checked=checked";}  ?>  title="<?php echo $title[3];?>">
                    2<input type="radio" name="answer_2" value="<?php echo 2*$data_bobot[2]."|2";?>" <?php if($skala[2]=='2'){ echo "checked=checked";}  ?> title="<?php echo $title[3];?>">
                    1<input type="radio" name="answer_2" value="<?php echo 1*$data_bobot[2]."|1";?>" <?php if($skala[2]=='1'){ echo "checked=checked";}  ?> title="<?php echo $title[3];?>">
                  </td>
                 ...
                 <tr>
                    ...
                    <td class="text-left">
                    <?php
                      $title[5]="penelitian tergolong baru atau jarang dilakukan";
                      $title[3]="penelitian tergolong sudah umum ";
                    ?>
                    5<input type="radio" name="answer_3" value="<?php echo 5*$data_bobot[3]."|5";?>" <?php if($skala[3]=='5'){ echo "checked=checked";}  ?> title="<?php echo $title[5];?>">
                    4<input type="radio" name="answer_3" value="<?php echo 4*$data_bobot[3]."|4";?>" <?php if($skala[3]=='4'){ echo "checked=checked";}  ?> title="<?php echo $title[5];?>">
                    3<input type="radio" name="answer_3" value="<?php echo 3*$data_bobot[3]."|3";?>" <?php if($skala[3]=='3'){ echo "checked=checked";}  ?> title="<?php echo $title[3];?>">
                    2<input type="radio" name="answer_3" value="<?php echo 2*$data_bobot[3]."|2";?>" <?php if($skala[3]=='2'){ echo "checked=checked";}  ?> title="<?php echo $title[3];?>">
                    1<input type="radio" name="answer_3" value="<?php echo 1*$data_bobot[3]."|1";?>"<?php if($skala[3]=='1'){ echo "checked=checked";}  ?> title="<?php echo $title[3];?>">
                  </td>
                 ...
                 <tr>
                    ...
                    <td class="text-left">
                    <?php
                      $title[5]="Hasil penelitian diperlukan oleh dan berdampak luas di masyarakat";
                      $title[4]="Hasil penelitian diperlukan oleh atau berdampak luas di masyarakat";
                      $title[3]="Hasil penelitian kurang diperlukan dan kurang berdampak luas di masyarakat";
                    ?>
                    5<input type="radio" name="answer_4" value="<?php echo 5*$data_bobot[4]."|5";?>" <?php if($skala[4]=='5'){ echo "checked=checked";}  ?> title="<?php echo $title[5];?>">
                    4<input type="radio" name="answer_4" value="<?php echo 4*$data_bobot[4]."|4";?>" <?php if($skala[4]=='4'){ echo "checked=checked";}  ?> title="<?php echo $title[4];?>">
                    3<input type="radio" name="answer_4" value="<?php echo 3*$data_bobot[4]."|3";?>" <?php if($skala[4]=='3'){ echo "checked=checked";}  ?> title="<?php echo $title[3];?>">
                    2<input type="radio" name="answer_4" value="<?php echo 2*$data_bobot[4]."|2";?>" <?php if($skala[4]=='2'){ echo "checked=checked";}  ?> title="<?php echo $title[3];?>">
                    1<input type="radio" name="answer_4" value="<?php echo 1*$data_bobot[4]."|1";?>"<?php if($skala[4]=='1'){ echo "checked=checked";}  ?> title="<?php echo $title[3];?>">
                  </td>
                    </td>
                 ...
                 <tr>
                    ...
                    <td class="text-left">
                    <?php
                      $title[5]="Metode penelitian sesuai masalah dan diuraikan terperinci ";
                      $title[3]="Metode penelitian kurang tepat dan atau diuraikan kurang terperinci Tidak ada metode penelitian ";
                    ?>
                 ...
                 <tr>
                    ...
                    <td class="text-left">
                    <?php
                      $title[5]="Sumber pustaka relevan dan mutakhir dan jumlahnya memadai ";
                      $title[3]="Sumber pustaka relevan, tapi kurang mutakhir atau jumlahnya kurang memadai";
                      $title[1]="Sumber pustaka kurang relevan ";
                    ?>
                  ...
                  <tr>
                    ...
                    <td class="text-left">
                    <?php
                      $title[5]="Uraian sistematis, kalimat efektif, dan penulisan ejaan umumnya benar ";
                      $title[3]="Uraian sistematis, kalimat efektif, dan atau penulisan ejaan banyak keliru ";
                      $title[1]="Uraian tidak sistematis dan kalimat tidak efektif";
                    ?>
                    ...
                    4<input type="radio" name="answer_7" value="<?php echo 4*$data_bobot[7]."|4";?>" <?php if($skala[7]=='4'){ echo "checked=checked";}  ?> title="<?php echo $title[5];?>">
                    3<input type="radio" name="answer_7" value="<?php echo 3*$data_bobot[7]."|3";?>" <?php if($skala[7]=='3'){ echo "checked=checked";}  ?> title="<?php echo $title[3];?>">
                    2<input type="radio" name="answer_7" value="<?php echo 2*$data_bobot[7]."|2";?>" <?php if($skala[7]=='2'){ echo "checked=checked";}  ?> title="<?php echo $title[3];?>">
                    1<input type="radio" name="answer_7" value="<?php echo 1*$data_bobot[7]."|1";?>"<?php if($skala[7]=='1'){ echo "checked=checked";}  ?> title="<?php echo $title[1];?>">
                  </td>
                   ...
                   <td class="text-left"><?php echo $data_pertanyaan[8];?></td>
                    <td class="text-left">
                      <?php
                      if ($skema=='penelitian dasar')
                      {
                        $title[5]="Peta jalan penelitian jelas dan realistis ";
                        $title[3]="Peta jalan penelitian kurang jelas dan atau kurang realistis ";
                        $title[1]="Tidak ada peta jalan ";
                      }
                      else
                      {
                        $title[5]="Mitra relevan dan mewakili lembaga resmi atau berbadan hukum (misal CV, PT, RT/RW, DKM masjid, karang taruna, koperasi, kelurahan, sekolah, pesantren, dll)";
                        $title[3]="Mitra relevan dan mewakili kelompok masyarakat yang lembaga tidak resmi atau tidak berbadan hukum (misal: kelompok ibu-ibu arisan, kelompok tani, kelompok pengusaha kecil, dll)";
                        $title[1]="Mitra relevan yang mewakili perorangan ";
                      }
                  ...
                  <tr>
                    ...
                    <td class="text-left"><?php echo $data_pertanyaan[9];?></td>
                    <td class="text-left">
                     <?php
                      $title[5]="Butir RAB sesuai kebutuhan dan biaya yang diajukan wajar";
                      $title[3]="Butir RAB kurang sesuai kebutuhan dan atau biaya yang diajukan kurang wajar ";
                    ?>
                    5<input type="radio" name="answer_9" value="<?php echo 5*$data_bobot[9]."|5";?>" <?php if($skala[9]=='5'){ echo "checked=checked";}  ?> title="<?php echo $title[5];?>">
                    4<input type="radio" name="answer_9" value="<?php echo 4*$data_bobot[9]."|4";?>" <?php if($skala[9]=='4'){ echo "checked=checked";}  ?> title="<?php echo $title[5];?>">
                    3<input type="radio" name="answer_9" value="<?php echo 3*$data_bobot[9]."|3";?>" <?php if($skala[9]=='3'){ echo "checked=checked";}  ?> title="<?php echo $title[3];?>">
                    2<input type="radio" name="answer_9" value="<?php echo 2*$data_bobot[9]."|2";?>" <?php if($skala[9]=='2'){ echo "checked=checked";}  ?> title="<?php echo $title[3];?>">
                    1<input type="radio" name="answer_9" value="<?php echo 1*$data_bobot[9]."|1";?>"<?php if($skala[9]=='1'){ echo "checked=checked";}  ?> title="<?php echo $title[3];?>">
                  </td>
