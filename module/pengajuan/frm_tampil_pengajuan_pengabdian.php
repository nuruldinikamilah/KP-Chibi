   ...
   if ($_GET['status']=='sukses')
    {
                           ...
                           <script>
                                    ...
                                    {
                                        $('#modal-dialog-sukses-isi-reviewer').modal('show');
                                    });
                            </script>
                            <?php
    }
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <table id="example" class="table table-striped table-bordered">
                    <thead>
                       <tr><th width="5%">No.</th><th width="10%">Tahun Pengajuan</th><th width="20%">Judul</th><th>Personil Penelitian</th><th>Rumpun Penelitian</th><th>Dana Pengajuan</th><th>Nama Reviewer</th><th>Status Proposal</th><th>Status Pengajuan</th><th>&nbsp;</th></tr>
                    </thead>
                    <tbody>
                       <?php
                        ...
                        <tr id=tr<?php echo $idx_enc;?>>
                           ...
                           <td>
                            ...
                            <?php
                              ...
                              {
                                ?>
                                <td><span class="text-info">Proposal Telah Diupload</span>
                                <?php
                              }
                              else
                              {
                                ?>
                                <td><span class="blink"><font color="red"><b>Pengusul Belum Upload Proposal</span></b></font>
                                <?php
                              }
                            ?>
                            <?php
