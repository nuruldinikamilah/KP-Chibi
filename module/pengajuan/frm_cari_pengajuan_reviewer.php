<?php
	...
	if ($_GET['judul'] != "")
	{
		...
		{
			$kondisiwhere .= "where a.judul_penelitian like '%".$_GET['judul']."%'";
...
<!-- begin panel -->
                                ...
                                <tbody>
                                  ...
                                  <tr class="active">
                                        ...
                                        <td>
                                        	...
                                        	if ($_GET['nip_peneliti']!='')
                                        	{
                                        		$tampil=mysqli_query($server1,"SELECT * FROM pengajuan_anggota_penelitian where nip_anggota=".$_GET['nip_peneliti']);
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Daftar Pengajuan Proposal Penelitian Internal Tahun ...........</h4>
            </div>
            <div class="panel-body">
                ...
                <table id="example" class="table table-striped table-bordered">
                    <thead>
                       <tr><th width="5%">No.</th><th width="10%">Tahun Pengajuan</th><th width="20%">Judul</th><th>Personil Penelitian</th><th>Rumpun Penelitian</th><th>Dana Pengajuan</th><th>NIP Reviewer</th><th>&nbsp;</th></tr>
                    </thead>
                    <tbody>
                       <?php
                     $sql_data_master=mysqli_query($server1,"SELECT 
															...
															FROM
															  ...
															  INNER JOIN `pengajuan_anggota_penelitian` e
															    ...
															    AND a.`idx_penelitian` = e.`idx_penelitian`
															  LEFT JOIN reviewer f
															    ON f.nip_reviewer = a.nip_reviewer ".$kondisiwhere."
  															GROUP BY judul_penelitian, `tahun_pengajuan`");
                     $no=1;
                     while($r=mysqli_fetch_array($sql_data_master))
                     {
                        ...
                        <tr id=tr<?php echo $idx_enc;?>>
                           ...
                           <td>
                            ...
                            ?>
                             <td>
                                <button type="button" class="btn btn-success btn-icon btn-circle" data-toggle="modal" data-target="#pengajuan-pemetaan-reviewer"  id=<?php echo "pemetaan_reviewer|".$idx_enc?>><i class="fa fa-external-link"></i></button>  
                        </tr>
