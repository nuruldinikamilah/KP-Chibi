   ...
   if ($_GET['status']=='sukses')
    {
                           ...
                           <script>
                                    ...
                                    {
                                        $('#modal-dialog-sukses').modal('show');
                                    });
                            </script>
                            <?php
    }
    ...
    <div class="col-12">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Daftar Pengajuan Proposal Penelitian Internal</h4>
            </div>
            <div class="panel-body">
                ...
                <table id="example" class="table table-striped table-bordered">
                    <thead>
                       <tr><th width="5%">No.</th><th width="10%">Tahun Pengajuan</th><th width="20%">Judul</th><th>Personil Penelitian</th><th>Rumpun Penelitian</th><th>Dana Pengajuan</th><th>Nama Reviewer</th><th>Status Pengajuan</th><th>File Dokumen Proposal</th><th>&nbsp;</th></tr>
                    </thead>
                    <tbody>
                       <?php
                     $sql_data_master=mysqli_query($server1,"SELECT
                                              ...
                                              WHERE tahun_pengajuan= YEAR(CURDATE())
                                                                   ");
                     $no=1;
                        ...
                        <tr id=tr<?php echo $idx_enc;?>>
                           ...
                           <td>
                            ...
                            <?php
                                ...
                                {
                                  ?>
                                  <td><b><a href="<?php echo "dokumen_upload/".$r['dokumen_proposal'];?>" download>File Dokumen</a></span>
                                  <?php
                                    $form_proposal=1;
                                }
                                else
