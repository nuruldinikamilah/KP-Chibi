...
if ($_POST['act']=='pemetaan_reviewer')
{
  ...
  ?>
 <form action="module/pengajuan/frm_get_data_pemetaan_reviewer_pengabdian_submit.php" method="post">
  <input type="hidden" value="<?php echo $data_id;?>" name="idx_pengabdian">
                ...
                <tbody>
                  ...
                  <tr>
                     ...
                     <td class="text-left" style="width: 20%">
                        <b>
                           <?php
                                    $sql_anggota=mysqli_query($server1,"select * from pengajuan_anggota_pengabdian where idx_pengabdian=".$data_id." order by status_peneliti desc");
                   ...
                   <tr>
                        ...
                        <?php
                               if ($rs['dokumen_proposal']!='')
                              {
                                ?>
                               <td style="text-align: left">
                                  <a href="<?php echo "dokumen_upload_pengabdian/".$rs['dokumen_proposal'];?>" download type="application/pdf">1. Download File Proposal</a><hr>
                                  <a href="<?php echo "dokumen_upload_lp_pengabdian/".$rs['dokumen_lembar_pengesahan'];?>" download type="application/pdf">2. Download File Cover dan Halaman Pengesahan</a><hr>
                                  <a href="<?php echo "dokumen_upload_mitra_pengabdian/".$rs['dokumen_lembar_mitra'];?>" download type="application/pdf">3. Download File Kesediaan Mitra</a>
                              </td>
                                <?php
                              }
                              else
                              {
                                ?>
                                <td style="text-align: left"><span class="blink"><font color="red"><b>Pengusul Belum Upload Proposal</span></b></font>
                                <?php
                              }
                            ?>
