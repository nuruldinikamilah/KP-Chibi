                        ...
                        <table class="table table-condensed table-striped table-bordered text-center">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="text-left col-md-2"><label for=""><b>Reviewer</b></label></th></th>
                                </tr>
                                <?php
                            ...
                            <thead>
                                 <tr>
                                    <th class="text-left col-md-2">
                                      <br>
                                      <center><h5><b>Video Simulasi Menilai Pengajuan Proposal</h5></b><hr>
                                       <video id="video2" width="640" height="280" poster="module/landing_page/gambar_video.png" controls>
                                          <source src="module/landing_page/penilaian_proposal.mp4" type="video/mp4">
                                      </video>
                                    </th>
                                    ...
                                    <th class="text-left col-md-2">
                                      <br>
                                      <center><h5><b>Video Simulasi Menilai Laporan Kemajuan Pengabdian</h5></b><hr>
                                       <video id="video2" width="640" height="280" poster="module/landing_page/gambar_video.png" controls>
                                          <source src="module/landing_page/laporan_kemajuan_reviewer.mp4" type="video/mp4">
                                      </video>
                                    </th>
                                    <th class="text-left col-md-2"><label for=""><b></b></label></th></th>
                                    <th class="text-left col-md-2"><label for=""><b></b></label></th></th>
