	...
	<div class="col-md-12">
		...
		<div class="panel panel-inverse">
			<div class="panel-heading">
				...
				<h4 class="panel-title">Form Pengajuan Dana Penelitian Tahun <?php echo date("Y");?></h4>
			</div>

			 <form action="module/penelitian_usulan_baru/frm_langkah_dua_pengajuan_dana_proses.php" method="post"  name="frm" class="form-inline" onsubmit="return validasi_frm_dana();">
			 	<?php
				//Jika Pernah Mengisi
			 	$idx=my_simple_crypt($_GET['idx'], 'd' );
			 	$sql=mysqli_query($server1,"select * from pengajuan_dana_penelitian where idx_penelitian=".$idx);
									...
									while($r=mysqli_fetch_array($sql))
									{
										...
										?>
											<tr id=tr<?php echo $idx_dana;?>>
												...
												<td class="text-left"><button type="button" class="btn btn-danger btn-sm m-r-5" data-toggle="modal" data-target="#hapus-modal-dana"     id=<?php echo "hapus|".$idx_dana."|".$nama_dana."|".$r['nominal_dana_pengajuan'];?>><i class="fa fa-edit"></i>Hapus</button></td>
											<tr>
										<?php
				...
				<!-- end col-12 -->
				<center><button class="btn btn-info m-r-5 m-b-5" type="submit">SIMPAN DATA PENGAJUAN DANA</button>
				</div>
				</form>
				<!-- end row -->