									...
									while($r=mysqli_fetch_array($sql))
									{
										...
										?>
											<tr id=tr<?php echo $idx_dana;?>>
												...
												<td class="text-left"><button type="button" class="btn btn-danger btn-sm m-r-5" data-toggle="modal" data-target="#hapus-modal-dana"     id=<?php echo "hapus|".$idx_dana."|".$nama_dana."|".$r['nominal_dana_pengajuan'];?> <?php echo $var_disabled;?>><i class="fa fa-edit"></i>Hapus</button></td>
											<tr>
										<?php
