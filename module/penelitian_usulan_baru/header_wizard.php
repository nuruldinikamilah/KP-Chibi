			...
			<div class="panel-body">			
				<ol class="bwizard-steps clearfix clickable" role="tablist">
					<li class="<?php echo $active_satu;?>" role="tab" style="z-index: 2;" aria-selected="true">
						...
						?>
						<a class="hidden-" href="view.php?menu=penelitian&act=usulan_baru_langkah_satu&<?php echo $link_1;?>">
							<font color="#000000">
								1. Identitas Usulan
							</a>
						</font>
					...
					<?php
						if (isset($_GET['idx']))
						{
							$link_1="idx=".$_GET['idx'];
							?>
								<a class="hidden-phone" href="view.php?menu=penelitian&act=usulan_baru_langkah_dua&<?php echo $link_1;?>">
							<?php
						}
						?>
						<font color="#000000">2. Pengajuan Dana Penelitian</a>
							 <small>-</small>
					...
					if (isset($_GET['idx']))
					{
						$link_1="idx=".$_GET['idx'];
						?>
						<a class="hidden-phone" href="view.php?menu=penelitian&act=usulan_baru_langkah_tiga&<?php echo $link_1;?>">
						<?php
					}
					?>
					<font color="#000000">3. Anggota Peneliti</a>
							 <small>-</small>
					...
					if (isset($_GET['idx']))
					{
						$link_1="idx=".$_GET['idx'];
						?>
						<a class="hidden-phone" href="view.php?menu=penelitian&act=usulan_baru_langkah_empat&<?php echo $link_1;?>">
						<?php
					}
					?>
					<font color="#000000">
					...
					if (isset($_GET['idx']))
					{
						$link_1="idx=".$_GET['idx'];
						?>
						<a class="hidden-phone" href="view.php?menu=penelitian&act=usulan_baru_langkah_lima&<?php echo $link_1;?>">
						<?php
					}
					?>
					<font color="#000000">
