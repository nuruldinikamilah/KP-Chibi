    ...
    <div class="col-12">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Daftar Pengabdian Internal Tahun <?php echo date("Y"); ?></h4>
            </div>
            <div class="panel-body">
			
					<table id="default_tabel" class="table table-striped table-bordered">
                    <thead>
                       <tr><th>No.</th><th>Tahun Pengajuan</th><th>Judul</th><th>Personil Penelitian</th><th>Rumpun Penelitian</th><th>Dana Pengajuan</th><th>Nama Reviewer</th><th>Status Pengajuan</th><th>Nilai Proposal</th><th>File Dokumen Kemajuan</th><th>Nilai Kemajuan Pengabdian</th><th>&nbsp;</th></tr>
                    </thead>
                    <tbody>
                       <?php
                     $sql_data_master=mysqli_query($server1,"SELECT 
                                                            ...
                                                            FROM
                                                              ...
                                                              INNER JOIN pengajuan_anggota_pengabdian e 
                                                                ...
                                                                AND e.`idx_pengabdian` = a.`idx_pengabdian` 
                                                              LEFT JOIN reviewer 
                                                                ON reviewer.nip_reviewer = a.nip_reviewer 
                        ...
                        <tr id=tr<?php echo $idx_enc;?>>
                           ...
                           <?php
                               if ($r['status_pengajuan']!='')
                               {
                                  ...
                                  {
                                    ?>
                                    <td><font color="black"><b><?php echo ucfirst($r['status_pengajuan']);?></span></b></td>
                                    <?php
                                  }
                                  else if ($r['status_pengajuan']=='diperiksa')
                                  {
                                  ?>
                                   <td><font color="green"><b>Dinilai</span></b></td>
                                  <?php
                                  } 
                              }
                              else
                              {
                                ?>
                                  <td><span class="blink"><font color="orange"><b>Diajukan</b></blink></span></td>
                                <?php
                              }
                            ?>   
                             <?php
                              ...
                              {
                                ?>
                                <td><span class="text-bold"><?php echo $r['nilai_keseluruhan_proposal'];?></span></td>
                                <?php
                              }
                              else
                              {
                                  ...
                                  ?>
                                  <td><span class="blink"><font color="red"><b>Reviewer Belum Menilai</b></blink></span></td>
                                  <?php
                              }
                            ?>
                           <?php
                                 if ($r['dokumen_laporan_kemajuan']!='')
                                {
                                  ?>
                                  <td><b><a href="<?php echo "dokumen_upload_kemajuan_pengabdian/".$r['dokumen_laporan_kemajuan'];?>" download>File Dokumen</a></span></td>
                                  <?php
                                    $form_proposal=1;
                                }
                                else
                                {
                                  ?>
                                  <td><span class="blink"><font color="red"><b>File Belum Diupload</b></blink></span></td>
                                  <?php
                                  $form_proposal=0;
                                }
                              ?>
                            <?php
                               if ($r['nilai_laporan_kemajuan']!='')
                              {
                                ?>
                                <td><span class="text-bold"><?php echo $r['nilai_laporan_kemajuan'];?></span></td>
                                <?php
                              }
                              else
                              {
                            ...
                            ?>
                            <td>
                              <button type="button" class="btn btn-success" data-toggle="modal" data-target="#kemajuan_koreksi_pengabdian"  id=<?php echo "kemajuan_koreksi_pengabdian|".$idx_enc."|laporan"?>>Lihat Hasil Penilaian Kemajuan</button> 
                            </td>
                        <?php
                        $no++;
                     }
					...
					<hr />
					<center><a class="btn btn-primary  btn-block" href="./module/laporan/download_laporan_pengabdian.php">Download Seluruh Data</a></center>
            </div>
        </div>
        <!-- end panel -->
    </div>
