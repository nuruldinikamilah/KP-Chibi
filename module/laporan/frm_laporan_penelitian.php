...
<div class="row">
    ...
    <div class="col-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-5">
           ...
           <form action="<?php echo "https://dp3m.unikom.ac.id/pengajuan/view.php" ?>?menu=pengajuan&act=cari_laporan" method="post" name="langkah_satu"  class="form-inline">
          ...
          <input type="hidden" name="klik" class="btn btn-sm btn-primary m-r-5"  Value="cari_data_laporan_penelitian_internal">
    ...
    <div class="col-12">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Daftar Pengajuan Proposal Penelitian Internal Tahun <?php echo date("Y"); ?></h4>
            </div>
            <div class="panel-body">
                ...
                <table id="example" class="table table-striped table-bordered">
                    <thead>
                       <tr><th width="5%">No.</th><th width="10%">Tahun Pengajuan</th><th width="20%">Judul</th><th>Personil Penelitian</th><th>Rumpun Penelitian</th><th>Dana Pengajuan</th><th>Nama Reviewer</th><th>Status Pengajuan</th><th>Nilai Proposal</th><th>Dokumen Proposal</th><th>Dokumen Lembar Pengesahan</th><th>Catatan Reviewer</th></tr>
                    </thead>
                    <tbody>
                       <?php
                     $sql_data_master=mysqli_query($server1,"SELECT
                                              ...
                                              WHERE a.`tahun_pengajuan`=YEAR(CURRENT_DATE())
                           ...
                           <td>
                            ...
                            <?php
                               if ($r['status_pengajuan']!='')
                               {
                                  ...
                                  else if ($r['status_pengajuan']=='ditolak')
                                  {
                                  ?>
                                   <td><span class="blink"><font color="red"><b>Ditolak</b></blink></span>
                                  <?php
                                  } 
                              }
                              else
                            ...
                            <td>
                              <?php
                                ...
                                {
                                  ?>
                                  <b><a href="<?php echo "dokumen_upload/".$r['dokumen_proposal'];?>" download>Download Proposal</a></span>
                                  <?php
                                    $form_proposal=1;
                                }
                                else
                            ...
                            <td>
                              <?php
                                ...
                                {
                                  ?>
                                  <b><a href="<?php echo "dokumen_upload_lp_penelitian/".$r['dokumen_lembar_pengesahan'];?>" download>Download Lembar Pengesahan</a></span>
                                  <?php
                                    $form_proposal=1;
                                }
                                else
					...
					<hr />
					<center><a class="btn btn-primary  btn-block" href="./module/laporan/download_laporan_penelitan.php">Download Seluruh Data</a></center>
            </div>
        </div>
        <!-- end panel -->
    </div>
