...
<!-- begin panel -->
                                ...
                                <tbody>
                                  ...
                                  <tr class="active">
                                        ...
                                        <td>
                                        	...
                                        	if ($_POST['nip_peneliti']!='')
                                        	{
                                        		$tampil=mysqli_query($server1,"SELECT * FROM pengajuan_anggota_penelitian where nip_anggota=".$_POST['nip_peneliti']);
                                 ...
                                 <tr class="success">
                                        ...
                                        <td>
                                        	...
                                        	if ($_POST['nip_reviewer']!='')
                                        	{
                                        		$tampil=mysqli_query($server1,"SELECT * FROM reviewer where nip_reviewer=".$_POST['nip_reviewer']);
                                        		$w = mysqli_fetch_array($tampil);
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Pencarian Pengajuan Penelitian Internal</h4>
            </div>
            <div class="panel-body">
                ...
                <table id="example" class="table table-striped table-bordered">
                    <thead>
                       <tr><th width="5%">No.</th><th width="10%">Tahun Pengajuan</th><th width="20%">Judul</th><th>Personil Penelitian</th><th>Rumpun Penelitian</th><th>Dana Pengajuan</th><th>NIP Reviewer</th><th>Status Pengajuan</th><th>Nilai Proposal</th></tr>
                    </thead>
                    <tbody>
                       <?php
