                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Form Pencarian Tahun dan Semster Laporan</h4>
                        </div>
                        <div class="panel-body">
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="langkah_satu"  >
                               <input type="hidden" value="frm_cari_laporan_skripsi" name="submit">
                                <br />
