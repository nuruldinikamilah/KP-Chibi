...
if ($_POST['act']=='validasi_reviewer')
{
  ...
  $sql_get_data=mysqli_query($server1,"SELECT
                                             ...
                                             WHERE a.`idx_pengabdian`= '".$data_id."'  ORDER BY a.`status_pengajuan`, a.`idx_pengabdian` DESC");
   $rs=mysqli_fetch_array($sql_get_data);

  ?>
 <form action="module/dir_lppm/get_data_validasi_pengajuan_pengabdian_submit.php" method="post">
  <input type="hidden" value="<?php echo $data_id;?>" name="idx_pengabdian">
                ...
                <tbody>
                  ...
                  <tr>
                        <td class="text-left align-text-bottom col-md-2" style="width: 20%">
                         <label for=""><b>Personil Pengabdian</b></label>
                     </td>
                     <td class="text-left" style="width: 20%">
                        <b>
                           <?php
                 ...
                 <tr>
                  ...
                  <tr>
                   ...
                   <tr>
                        ...
                        <td style="text-align: left">
                               <a href="<?php echo "dokumen_upload_pengabdian/".$rs['dokumen_proposal'];?>" download type="application/pdf">Download File Proposal</a>
                        </td>
                  </tr>
                  <tr>
                        <td class="text-left align-text-bottom col-md-2" style="width: 20%">
