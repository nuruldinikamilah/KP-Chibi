        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <table id="example" class="table table-striped table-bordered">
                    <thead>
                       <tr><th width="5%">No.</th><th width="10%">Tahun Pengajuan</th><th width="20%">Judul</th><th>Personil Penelitian</th><th>Rumpun Penelitian</th><th>Dana Pengajuan</th><th>Nama Reviewer</th><th>Status Pengajuan</th><th>Nilai Proposal</th><th>&nbsp;</th></tr>
                    </thead>
                    <tbody>
                       <?php
                     ...
                     while($r=mysqli_fetch_array($sql_data_master))
                     {
                        ...
                        <tr id=tr<?php echo $idx_enc;?>>
                           ...
                           <td>
                            ...
                            ?>
                             <td>
                              <button type="button" class="btn btn-success btn-icon btn-circle" data-toggle="modal" data-target="#validasi-pengajuan-penerimaan"  id=<?php echo "validasi_reviewer|".$idx_enc?>><i class="fa fa-share"></i></button>  
                        </tr>
