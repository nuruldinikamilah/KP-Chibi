<?php
  ...
  if (isset($_REQUEST['kategori_bidang_pilih_abdi']))
  {
  ?>
                  ...
                  <td class="text-left">
                                     ...
                                     <?php
                                               $sql=mysqli_query($server1,"SELECT * FROM ref_bidang_penelitian_simlitabmas where kode_kategori_bidang_penelitian_simlitabmas=".$_REQUEST['kategori_bidang_pilih_abdi']." ORDER BY nama ASC ");
                                                $no=1;
