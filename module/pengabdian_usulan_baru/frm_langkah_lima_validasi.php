	...
	<div class="col-md-12">
		...
		<div class="panel panel-inverse">
			...
			<?php
				...
				$sql_val_identitas_usulan=mysqli_query($server1,"select * from pengajuan_pengabdian where idx_pengabdian=".$idx);
				...
				$sql_val_dana=mysqli_query($server1,"select * from pengajuan_dana_pengabdian where idx_pengabdian=".$idx);
				...
				$sql_val_anggota=mysqli_query($server1,"select * from pengajuan_anggota_pengabdian where idx_pengabdian=".$idx);
			...
			?>
			<form action="module/pengabdian_usulan_baru/frm_langkah_lima_validasi_proses.php" method="post"  name="frm" id="frm_langkah_lima_validasi_proses" class="form-inline" onsubmit="return validasi_frm_ajukan_usulan();">
						...
						<thead>
							...
							<tr id=t_dokumen_file>
								...
								<td class="text-left align-text-bottom col-md-2" style="width: 60%;">
									...
									{
										?>
										<span class='blink'><font color='red'>Belum Mengajukan Usulan</span></font>
										<?php
									}
									?>
                            	</td>
				...
				<center>
					<?php
						...
						{
							?>
							<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ajukan_proposal_pengabdian" id=<?php echo $_GET['idx'];?>>Ajukan Usulan</button>
							<?php
						}
