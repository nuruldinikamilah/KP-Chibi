...
include "../../lib/enkripsi_decrpt.php";
        ...
        ?>
                ...
                <tbody>
                    <tr>
                     ...
                     <td class="text-left" style="width: 20%">
                        <label for=""><b>
                            <input type='text' id='nip_ubah' name='nip_ubah'>
                            <input type='hidden' id='idx' value='<?php echo $_POST['kata_kunci'];?>'>    
                        </b></label>
                    </td>
                 </tr>
                  <tr>
                     ...
                     <td class="text-left" style="width: 20%">
                         <input type='text' id='nama_ubah' name='nama_ubah' size='20'>
                    </td>
                 </tr>
                   <tr>
                        <td class="text-left align-text-bottom col-md-2" style="width: 20%">
                     ...
                     <td class="text-left" style="width: 20%">
                        <input type='text' id='nama_prodi' size='30'> 
                    </td>
                 </tr>
                  <tr>
                        <td class="text-left align-text-bottom col-md-2" style="width: 20%">
                     ...
                     <td class="text-left" style="width: 20%">
                        <input type='text' id='nama_universitas' size='30'> 
                    </td>
                 </tr>
                 <tr>
                        <td class="text-left align-text-bottom col-md-2" style="width: 20%">
                  ...
                  <tr>
                      ...
                      <td class="text-left" style="width: 20%">
                        ...
                        <input type='hidden' id='keterangan_peneliti' value='DosenLuar'> 
                    </td>
                 </tr>   
             </tbody>
            </table>
            <!-- Modal Footer -->
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary submitBtn" onclick="ubah_peneliti_dosen_luar()">Ubah Peneliti</button>
                    </div>
        <?php
    }
    ...
    {
            ?>
                <center><h5>Data Peneliti Dosen : <?php echo $_POST['kata_kunci'];?> Tidak Ditemukan</h5></center>
            <?php
    }
?>
