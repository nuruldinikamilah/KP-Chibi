    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Form Unggah Dokumen Proposal Pengabdian <?php echo date("Y");?></h4>
            </div>

            <br>
            

            <form action="module/pengabdian_usulan_baru/frm_langkah_empat_unggah_dokumen_proses.php" method="post"  name="frm" class="form-inline" onsubmit="return validasi_frm_dokumen_proposal();" enctype="multipart/form-data">
                        ...
                        <thead>
                            <tr id=t_dokumen_file>
                                <td class="text-left align-text-bottom col-md-2 align-middle" style="width: 40%">
                                    <label for=""><b>Masukan File Dokumen Proposal Pengabdian 
                                        <br>1. File Proposal Tanpa Cover,<br>2. Tanpa Halaman Pengesahan<br>3. Tanpa Lembar Kesediaan Mitra</b></label>
                                </td>
                            ...
                            if ($r['dokumen_proposal']!='')
                            {
                                ...
                                <tr>
                                    <td class="text-left align-text-bottom col-md-2 align-middle">
                                     ...
                                     <td class="text-left align-text-bottom col-md-2 align-middle">
                                        <br><a href="<?php echo "dokumen_upload_pengabdian/".$r['dokumen_proposal'];?>" download>Download File Proposal</a>
                            ...
                            <tr id=t_dokumen_file_lp>
                                <td class="text-left align-text-bottom col-md-2 align-middle" style="width: 40%">
                                    ...
                                    <br>
                                    <a href="<?php echo "module/pengabdian_usulan_baru/lembar_pengesahan.php?idx=".$_GET['idx'];?>" download>Download Lembar Pengesahan</a>
                                </td>
                                <td class="text-left align-text-bottom col-md-2" style="width: 60%;">
                                <span class="btn btn-danger fileinput-button btn-xs m-r-5">
                                    <i class="fa fa-plus"></i> 
                            ...
                            if ($r['dokumen_lembar_pengesahan']!='')
                            {
                                ...
                                <tr>
                                    <td class="text-left align-text-bottom col-md-2 align-middle">
                                     ...
                                     <td class="text-left align-text-bottom col-md-2 align-middle">
                                        <br><a href="<?php echo "dokumen_upload_lp_pengabdian/".$r['dokumen_lembar_pengesahan'];?>" download>Download File Lembar Pengesahan Yang Sudah Ditandatangani</a>
                            ...
                            if ($r['dokumen_lembar_mitra']!='')
                            {
                                ...
                                <tr>
                                    <td class="text-left align-text-bottom col-md-2 align-middle">
                                     ...
                                     <td class="text-left align-text-bottom col-md-2 align-middle">
                                        <br><a href="<?php echo "dokumen_upload_mitra_pengabdian/".$r['dokumen_lembar_mitra'];?>" download>Download File kesediaan mitra</a>
