    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse">
         ...
         <table id="tabel_distribusi" class="table table-striped table-bordered">
              <thead>
                <tr><th width="5%"></th><th width="8%">Tahun Pengajuan</th><th width="15%">Judul</th><th>Personil Pengabdian</th><th width="10%">Rumpun Pengabdian</th><th>Dana</th><th>File Proposal</th><th>Status Proposal</th><th>Komentar Reviewer</th></tr>
                 </thead>
                    <tbody>
                      <?php
                    ...
                    $no=1;
                     while($r=mysqli_fetch_array($sql_data_master))
                     {
                       ...
                       <tr id=tr<?php echo $idx_enc;?>>
                          <td> <a href="<?php echo "view.php?menu=pengabdian&act=usulan_baru_langkah_satu&idx=".$idx_enc;?>" class="btn btn-primary btn-sm m-r-5"><i class="fa fa-edit"></i>&nbsp;Ubah
                              </a>
